...
class GeoTiltakspakkeRegelTest :
    FunSpec({
        ...
        test("returnerer TILTAKSGRUPPE når fylke er i scopet og sannsynligeht = 1.0") {
            val regel = GeoTiltakspakkeRegel(fylkerIScopet = setOf("50"), sannsynlighet = 1.0, tiltakspakkeId = "test")
        ...
        test("returnerer KONTROLLGRUPPE når fylke er i scopet og sannsynglihet = 0.0") {
            val regel = GeoTiltakspakkeRegel(fylkerIScopet = setOf("50"), sannsynlighet = 0.0, tiltakspakkeId = "test")
