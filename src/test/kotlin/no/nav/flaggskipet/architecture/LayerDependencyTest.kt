package no.nav.flaggskipet.architecture
...
private class TestContext {
    val projectRoot: Path = Path.of("src/main/kotlin/no/nav/flaggskipet")
    val rules =
        listOf(
            LayerRule(
...
private const val BASE_PACKAGE = "no.nav.flaggskipet"
